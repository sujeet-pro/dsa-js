...
import { bubbleSort as solutionImpl, type SortFn } from './bubble-sort.solution.ts'
import { bubbleSort as practiceImpl, bubbleSort2 } from './bubble-sort.practise.ts'

const implementations = {
  solution: solutionImpl,
  practice: practiceImpl,
  practice2: bubbleSort2,
}

testImplementations<SortFn>('bubbleSort', implementations, (testEach) => {
  // ============================================================
  // BASIC FUNCTIONALITY
  // ============================================================
